...
<title><h:outputText value="#{msgs.register_atendent}" /></title>
	</head>
	<body>
		...
		<h:form>
			...
			<label for="turnos"> <h:outputText value="#{msgs.turn}" />
			</label>
			<h:selectOneMenu value="#{cadastroFuncionarioBean.turno}">
				<f:selectItems value="#{cadastroFuncionarioBean.turnos}" />
			</h:selectOneMenu>

			<br />

			<h:commandButton
				action="#{cadastroFuncionarioBean.cadastrarAtendente}"
				value="#{msgs.register}" />
